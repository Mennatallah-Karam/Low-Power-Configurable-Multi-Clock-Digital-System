...
create_generated_clock -master_clock $CLK2_NAME -source [get_ports UART_CLK] -name "UART_RX_CLK" [get_port CLK_DIV_RX_INST/o_div_clk] -divide_by 1
...
create_generated_clock -master_clock $CLK2_NAME -source [get_ports UART_CLK] -name "UART_TX_CLK" [get_port CLK_DIV_TX_INST/o_div_clk] -divide_by 32
